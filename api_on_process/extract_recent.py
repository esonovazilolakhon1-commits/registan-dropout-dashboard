...
ENDPOINTS = [
    ...
    # students — must use full history from_date (2020) so all enrolled students
    # are returned. API returns 0 when fromDate is set to RECENT_FROM (2026)
    # because no students were newly created in that narrow window.
