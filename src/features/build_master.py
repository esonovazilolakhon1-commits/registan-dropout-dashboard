...
st       = pd.read_parquet(STUDENTTEACHERS_CLEAN) if STUDENTTEACHERS_CLEAN.exists() else pd.DataFrame()
users    = pd.read_parquet(USERS_CLEAN) if USERS_CLEAN.exists() else pd.DataFrame(columns=["userId","fullName"])
